...
function TabsTrigger(
  ...
  return (
    <TabsPrimitive.Trigger
      ...
      className={cn(
        "inline-flex h-[calc(100%-1px)] flex-1 items-center justify-center gap-1.5 rounded-md border border-transparent px-2 py-1 text-sm font-medium whitespace-nowrap transition-[color,box-shadow,border-color]",
        "text-muted-foreground",
        "data-[state=active]:bg-card data-[state=active]:text-[var(--color-custume-blue)] dark:data-[state=active]:text-[var(--color-light-blue)]",
